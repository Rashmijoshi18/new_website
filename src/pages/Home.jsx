...
// export default function Home() {
//   return (
//     <div className="flex flex-col gap-8 px-4 py-6 sm:px-6 md:px-10 lg:px-16 bg-[#0d1117] text-gray-100 min-h-screen">
//       {/* Header Section */}
//       <header className="text-center md:text-left">
//         <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">
//           Developer Portfolio API
//         </h1>
//         <p className="text-sm sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto md:mx-0">
...
//             GET
//           </span>
//           <code className="px-2 py-1 rounded bg-gray-800 text-xs sm:text-sm md:text-base text-gray-200">
//             /developer/introduction
//           </code>
//         </div>
...
export default function Home() {
  return (
    <div className="flex flex-col gap-8 px-4 py-6 sm:px-6 md:px-10 lg:px-16 bg-[#0d1117] text-gray-100 min-h-screen pt-20 md:pt-12 lg:pt-8">
      {/* ↑ Responsive padding-top added here */}
