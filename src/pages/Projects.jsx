...
const projects = [
  ...
  },
  {
    title: "Weather Check",
    description:
      "Real-time weather updates and forecasts based on user location with beautiful UI.",
    image: weather_check,
  ...
  },
  {
    title: "FitLife",
    description:
      "Modern fitness platform offering workout programs to support your healthy lifestyle.",
    image: fit,
    tech: ["React", "Tailwind CSS", "JavaScript"],
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl font-bold text-green-700 mb-4">
            Featured
            <span className="text-4xl font-bold text-green-700 mb-4">
              {" "}
              Projects
            </span>
          </h2>
